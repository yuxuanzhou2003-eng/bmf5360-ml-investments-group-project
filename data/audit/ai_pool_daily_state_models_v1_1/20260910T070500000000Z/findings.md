# Independent validation — 20260910T070000000000Z

- **Validation status**: `PASS`
- **Validation time (UTC)**: `2026-09-10T07:03:11.046353+00:00`
- **Model run**: `data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z`
...
| `output_hash_validation_predictions.csv` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/validation_predictions.csv |
| `output_hash_validation_metrics.csv` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/validation_metrics.csv |
| `output_hash_feature_importance.csv` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/feature_importance.csv |
| `output_hash_feature_sets.json` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/feature_sets.json |
| `output_hash_rf_tuning_evidence.json` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/rf_tuning_evidence.json |
| `output_hash_technical_only_logistic.joblib` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/models/technical_only_logistic.joblib |
| `output_hash_technical_only_random_forest.joblib` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/models/technical_only_random_forest.joblib |
| `output_hash_technical_plus_macro_logistic.joblib` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/models/technical_plus_macro_logistic.joblib |
| `output_hash_technical_plus_macro_random_forest.joblib` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/models/technical_plus_macro_random_forest.joblib |
| `output_hash_technical_plus_ai_state_logistic.joblib` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/models/technical_plus_ai_state_logistic.joblib |
| `output_hash_technical_plus_ai_state_random_forest.joblib` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/models/technical_plus_ai_state_random_forest.joblib |
| `output_hash_full_state_logistic.joblib` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/models/full_state_logistic.joblib |
| `output_hash_full_state_random_forest.joblib` | PASS | model-run output hash matches for data/model_runs/ai_pool_daily_state_models_v1_1/20260910T070000000000Z/models/full_state_random_forest.joblib |
